...
def get_train_args(args: Optional[Dict[str, Any]] = None) -> _TRAIN_CLS:
    ...
    if finetuning_args.stage != "sft" and finetuning_args.stage != "cls" and finetuning_args.stage != "rcls" and finetuning_args.stage != "rwcls" and finetuning_args.stage != "dyna" and finetuning_args.stage != "gan":
